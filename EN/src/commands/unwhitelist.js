...
module.exports = {
    name: 'unwhitelist',
    description: 'Remove Minecraft players from the whitelist.',
    usage: '`'+prefix+'unwhitelist {server name|ID|address} {Minecraft player}`',
    ...
    execute(bot, msg, args){
        async function APIunwhitelist(){
            try{
                ...
                console.error(`Error while executing command "unwhitelist": ${e.message}`)
