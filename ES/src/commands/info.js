    ...
    async execute(bot, msg, args){
        try{
            ...
            .addFields(
                ...
                {name:'Versión actual', value:'[v4.2.3](https://github.com/Alex0622/PhoenixAPI-Bot/releases/tag/v4.2.3)', inline:true},
                {name:'Prefijo', value:'`'+prefix+'`', inline:true},
                {name:'Enlaces', value:'[GitHub](https://github.com/Alex0622/PhoenixAPI-Bot) | [Documentación de la API de exaroton](https://support.exaroton.com/hc/en-us/articles/360019857878-API-documentation) | [Tutorial de instalación](https://www.youtube.com/watch?v=lYosqjZpIBE)', inline:false}
            )
